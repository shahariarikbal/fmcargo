                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('testimonial.update', $testimonial->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                                ...
                                <x-admin.input type="text" id="reviewer_name" name="reviewer_name" value="{{ $testimonial?->reviewer_name }}" placeholder="Enter reviewer name..."></x-admin.input>
                            ...
                            <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                                ...
                                <x-admin.input type="text" id="reviewer_designation" name="reviewer_designation" value="{{ $testimonial?->reviewer_designation }}" placeholder="Enter reviewer designation..."></x-admin.input>
                            ...
                            <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                                ...
                                <x-admin.input type="text" id="short_comment" name="short_comment" value="{{ $testimonial?->short_comment }}" placeholder="Enter short comment..."></x-admin.input>
                            ...
                            <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                                ...
                                <x-admin.textarea id="long_comment" class="ckeditor" rows="8" name="long_comment" value="{{ $testimonial?->long_comment }}" placeholder="Enter long description..."></x-admin.textarea>
