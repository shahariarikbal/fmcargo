...
@section('content')
    <h1 class="mt-4">Customer Booking Details View</h1>
    <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <x-admin.input-group-div style="width: calc( 33.33% - 10px ); margin-right: 10px;">
                            ...
                            <x-admin.input type="text" id="name" name="name" readonly value="{{ $booking->name ?? old('name') }}" placeholder="Enter your full name..."></x-admin.input>
                        ...
                        <x-admin.input-group-div style="width: calc( 33.33% - 10px ); margin-right: 10px;">
                            ...
                            <x-admin.input type="tel" id="phone" name="phone" readonly value="{{ $booking->phone ?? old('phone') }}" placeholder="Enter your phone number..."></x-admin.input>
                            <x-admin.input-error for="phone" class="mt-2"></x-admin.input-error>
                        </x-admin.input-group-div>

                        <x-admin.input-group-div style="width: calc( 33.33% - 10px ); margin-right: 10px;">
                            <x-admin.label for="email">Email</x-admin.label>
                            <x-admin.input type="email" id="email" name="email" readonly value="{{ $booking->email ?? old('email') }}" placeholder="Enter your email..."></x-admin.input>
                    ...
                    <div class="input-group">
                        <x-admin.input-group-div style="width: calc( 50% - 10px ); margin-right: 10px;">
                            ...
                            <x-admin.textarea name="pick_up_address" readonly id="pick_up_address" rows="5" placeholder="Enter Pick up address">{{ $booking->pick_up_address }}</x-admin.textarea>
                        ...
                        <x-admin.input-group-div style="width: calc( 50% - 10px ); margin-right: 10px;">
                            ...
                            <x-admin.textarea name="drop_of_address" readonly id="drop_of_address" rows="5" placeholder="Enter Drop of address">{{ $booking->drop_of_address }}</x-admin.textarea>
                    ...
                    <div class="input-group">
                        <x-admin.input-group-div style="width: calc( 50% - 10px ); margin-right: 10px;">
                            ...
                            <x-admin.input name="weight_pcs" readonly value="{{ $booking->weight_pcs ?? old('weight_pcs') }}" id="weight_pcs" placeholder="Enter Product weight or pcs"></x-admin.input>
                        ...
                        <x-admin.input-group-div style="width: calc( 50% - 10px )">
                            ...
                            <x-admin.select-option name="unit" id="unit" disabled>
                    ...
                    <div class="input-group">
                        <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-right: 10px;">
                            ...
                            <x-admin.textarea name="product_description" readonly id="product_description" rows="5" placeholder="Enter Parcel details">{{ $booking->product_description }}</x-admin.textarea>
