...
@section('content')
    <h1 class="mt-4">About Us Edit</h1>
    <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('about_us.update', $about_us?->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                            ...
                            <x-admin.input type="text" id="title_en" name="title_en" value="{{ $about_us?->title_en ?? old('title_en') }}" placeholder="Enter title..."></x-admin.input>
                        ...
                        <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                            ...
                            <x-admin.input type="text" id="title_bn" name="title_bn" value="{{ $about_us?->title_bn ?? old('title_bn') }}" placeholder="Enter service title..."></x-admin.input>
                        ...
                        <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                            ...
                            <x-admin.textarea id="description_en" class="ckeditor" name="description_en" placeholder="Enter service description...">{{ $about_us?->description_en ?? old('description_en') }}</x-admin.textarea>
                        ...
                        <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                            ...
                            <x-admin.textarea id="description_bn" class="ckeditor" name="description_bn" placeholder="Enter service description...">{{ $about_us?->description_bn ?? old('description_bn') }}</x-admin.textarea>
