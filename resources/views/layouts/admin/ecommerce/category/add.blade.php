                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('category.store') }}" method="post">
                            ...
                            <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                                ...
                                <x-admin.input type="text" id="name_en" name="name_en" value="{{ old('name_en') }}" placeholder="Enter category name..."></x-admin.input>
                            ...
                            <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                                ...
                                <x-admin.input type="text" id="name_bn" name="name_bn" value="{{ old('name_bn') }}" placeholder="Enter category name..."></x-admin.input>
