    ...
    <div class="card mb-4">
        ...
        <div class="row" style="padding: 30px;">
            ...
            <div class="col-md-8" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                <div class="card-body">
                    <x-admin.action-button href="{{ route('category.list') }}" class="btn-primary float-end"> <i class="fas fa-arrow-alt-circle-left"></i> Manage</x-admin.action-button>
                    <form action="{{ route('category.update', $category->id) }}" method="post">
                        @csrf
                        <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                            <x-admin.label for="name_en">Name</x-admin.label>
                            <x-admin.input type="text" id="name_en" name="name_en" value="{{ $category?->name_en ?? old('name_en') }}" placeholder="Enter your full name..."></x-admin.input>
                        ...
                        <x-admin.input-group-div style="width: calc( 100% - 10px ); margin-top: 20px;">
                            ...
                            <x-admin.input type="text" id="name_bn" name="name_bn" value="{{ $category?->name_bn ?? old('name_bn') }}" placeholder="Enter your full name..."></x-admin.input>
