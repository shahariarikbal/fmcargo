...
@section('content')
    ...
    <section class="banner-section">
        <div class="container">
            <div class="banner-content-wrapper">
                <h1 class="banner-title">{{ $clear_forwarding->{ 'header_title_'.app()->getLocale() } }}</h1>
                <ul class="banner-item">
                    ...
                    <li class="active">
                        <a href="javascript:void(0)">
                            {{ $clear_forwarding->{ 'header_title_'.app()->getLocale() } }}
                        </a>
                    </li>
                </ul>
            </div>
    	...
    	<div class="container">
    		<div class="service-details-top-outer">
		        ...
		        <p class="service-details-text">
		        	{{ $clear_forwarding->{ 'header_desc_'.app()->getLocale() } }}
		        </p>
		    </div>
    	</div>
    </section>
            ...
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $clear_forwarding->{ 'pro_sourcing_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $clear_forwarding->{ 'pro_sourcing_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
        ...
        <div class="container">
            <div class="row align-items-center">
            	...
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $clear_forwarding->{ 'free_warehousing_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $clear_forwarding->{ 'free_warehousing_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
        ...
        <div class="container">
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $clear_forwarding->{ 'inspection_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $clear_forwarding->{ 'inspection_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
        ...
        <div class="container">
            <div class="row align-items-center">
            	...
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $clear_forwarding->{ 'repacking_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $clear_forwarding->{ 'repacking_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
        ...
        <div class="container">
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $clear_forwarding->{ 'custom_clr_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $clear_forwarding->{ 'custom_clr_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
        ...
        <div class="container">
            <div class="row align-items-center">
            	...
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $clear_forwarding->{ 'd_step_delivery_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
                            {{ $clear_forwarding->{ 'd_step_delivery_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
    ...
    <section class="service-details-section">
    	<div class="container">
    		<div class="service-details-top-outer">
		        <p class="service-details-text">
		        	{{ $clear_forwarding->{ 'footer_desc_'.app()->getLocale() } }}
		        </p>
