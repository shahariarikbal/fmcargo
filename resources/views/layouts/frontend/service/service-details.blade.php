...
@section('content')
    ...
    <section class="banner-section">
        <div class="container">
            <div class="banner-content-wrapper">
                <h1 class="banner-title">{{ $door_to_door->{ 'header_title_'.app()->getLocale() } }}</h1>
                <ul class="banner-item">
                    ...
                    <li class="active">
                        <a href="javascript:void(0)">
                            {{ $door_to_door->{ 'header_title_'.app()->getLocale() } }}
                        </a>
                    </li>
                </ul>
            </div>
    	...
    	<div class="container">
    		<div class="service-details-top-outer">
		        ...
		        <p class="service-details-text">
		        	{{ $door_to_door->{ 'header_desc_'.app()->getLocale() } }}
		        </p>
		    </div>
    	</div>
    </section>
            ...
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $door_to_door->{ 'pro_sourcing_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $door_to_door->{ 'pro_sourcing_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
            	...
            	<div class="col-md-6">
            		<div class="service-details-right">
            			<img src="{{ asset('door_to_door/'.$door_to_door->pro_sourcing_img) }}">
            		</div>
            	</div>
            </div>
        </div>
    ...
    <section class="service-details-section">
        <div class="container">
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-right">
            			<img src="{{ asset('door_to_door/'.$door_to_door->free_warehousing_img) }}">
            		</div>
            	</div>
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $door_to_door->{ 'free_warehousing_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $door_to_door->{ 'free_warehousing_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
        ...
        <div class="container">
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $door_to_door->{ 'inspection_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $door_to_door->{ 'inspection_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
            	...
            	<div class="col-md-6">
            		<div class="service-details-right">
            			<img src="{{ asset('door_to_door/'.$door_to_door->inspection_img) }}">
            		</div>
            	</div>
            </div>
        </div>
    ...
    <section class="service-details-section">
        <div class="container">
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-right">
            			<img src="{{ asset('door_to_door/'.$door_to_door->repacking_img) }}">
            		</div>
            	</div>
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $door_to_door->{ 'repacking_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $door_to_door->{ 'repacking_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
        ...
        <div class="container">
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $door_to_door->{ 'custom_clr_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $door_to_door->{ 'custom_clr_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
            	...
            	<div class="col-md-6">
            		<div class="service-details-right">
            			<img src="{{ asset('door_to_door/'.$door_to_door->custom_clr_img) }}">
            		</div>
            	</div>
            </div>
        </div>
    ...
    <section class="service-details-section">
        <div class="container">
            <div class="row align-items-center">
            	<div class="col-md-6">
            		<div class="service-details-right">
            			<img src="{{ asset('door_to_door/'.$door_to_door->d_step_delivery_img) }}">
            		</div>
            	</div>
            	<div class="col-md-6">
            		<div class="service-details-left">
            			<h3 class="service-details-title">
            				{{ $door_to_door->{ 'd_step_delivery_title_'.app()->getLocale() } }}
            			</h3>
            			<p class="service-details-text">
            				{{ $door_to_door->{ 'd_step_delivery_desc_'.app()->getLocale() } }}
            			</p>
            			{{--  <p class="service-details-text">
    ...
    <section class="service-details-section">
    	<div class="container">
    		<div class="service-details-top-outer">
		        <p class="service-details-text">
		        	{{ $door_to_door->{ 'footer_desc_'.app()->getLocale() } }}
		        </p>
